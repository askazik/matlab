...
while i < n
    ...
    if FrequencyData.count_o < 255 % зондирование на данном частотном канале не производится (частота блокирована аппаратно)
    ...
    if FrequencyData.count_x < 255 % зондирование на данном частотном канале не производится (частота блокирована аппаратно)
...
% Затычка, чтобы не выйти за ионограмму.

function [Ne,h,outf,oarr] = iri2012cor(alati,along,iyyyy,mmdd,dhour,vbeg,vend,vstp,...
...
% [outf,oarr] = mexIRI2012(jmag,jf,alati,along,iyyyy,mmdd,iut,dhour,...
...
%       OARR(25) = DIP (geomagnetic inclination in degrees)/deg OARR(26) = DIP LATITUDE/deg

function Denisenko_Nigth_Nh_from_hv_IRI_real(f, hv, f_N, h_N, ks_title)
...
figure('NumberTitle','off','Name',['F-region: ','nE=',num2str(nE),'  sigE=',num2str(sigmaE),...
...
ylabel('h & h_v, km')
xlabel('f & f_N, MHz')
legend('h(IRI)','h_c_o_r(E)','h_c_o_r(F)','h_v(exper)','h_v(calc)','Location','northeast')
title(ks_title)
grid on
